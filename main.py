...
def build_user_profile(user_id):
    user_history = users_data[users_data['user_id']
                              == user_id]['listening_history']
    user_genre_preferences = users_data[users_data['user_id']
                                        == user_id]['genre_preferences']
...
def collaborative_filtering(user_profile):
    ...
    top_recommendations = users_data[users_data['user_id'].isin(
        similar_users)]['listening_history']
